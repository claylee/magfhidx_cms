  ...
  var _ = {
    ...
    changeState: function (e) {
      ...
      _.DOMReady(function () {
        ...
        _[t].IEVersion > 8 && (n = '_skel_cell_important_placeholder', e = _.getElementsByClassName('skel-cell-important'), e && e[A] > 0 && _[o](e, function (t) {
          if (t === A) return;
          var r = e[t],
          s = r[M],
          o;
      ...
      function buildTest(e, t) {
        ...
        t == '*' ? r = function (e) {
         ...
         : t.charAt(0) == n ? (fArgs[e] = parseInt(t.substring(1)), r = function (t) {
          ...
          return t >= fArgs[e]
        })  : _.indexOf(t, n) != - 1 ? (t = t.split(n), fArgs[e] = [
          parseInt(t[0]),
          parseInt(t[1])
        ], r = function (t) {
