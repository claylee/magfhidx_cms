...
class Cast(db.Model):
    ...
    _img = Column('img',String(200))
    castdate = Column(String(20))
    birthdate = Column(String(20))
    _tags = Column('tags',String(50))
    alias = Column(String(50))
    hot = Column(Integer)
    desc = Column(String(300))
    imgpost = Column(String(200))
    imgpost_thumb = Column(String(200))
    pimg_key = Column(String(20))
    pimg_thumb_key = Column(String(20))
    ...
    def img(self):
        #return self._img
        if self.imgpost is None or self.imgpost == '':
            return self._img
        return self.imgpost
        #return self.imgpost.replace(self.pimg_thumb_key,self.pimg_key)
...
class Publisher(db.Model):
    ...
    imgpost = Column('imgpost',String(200))
    cnt = Column(Integer)
    tags= Column(String(500))



class Fanhao(db.Model):
    __tablename__ = 'fanhao'
    id = Column(Integer, primary_key=True)
    no = Column(String(50))
    ...
    pimg_thumb_key = Column(String(20))
    _img = Column('img',String(200))
    img2 = Column('img2',String(200))
    _tags = Column('tags',String(200))
    _cast = Column('cast', String(200))
    ...
    desc_jp = Column(String(500))
    _prev_img = Column('prev_img',String(500))

    create_date = Column(String(20))
    site = Column(String(50))

    imgurl = 'https://github.com/claylee/fhpic/blob/master'
    imgurl_org = 'http://pic.mmyszx.com/pic'
...
class Publisher_tag(db.Model):
    __tablename__ = 'Publisher_tag'
    id = Column(Integer, primary_key=True)
    publisher = Column(String(50))
...
class Topic(db.Model):
    ...
    @cached_property
    def ext_cast(self):
        return Cast.query.filter(Cast.name==self.name).first()
...
class Article(db.Model):
    ...
    topics = db.relationship(Topic, secondary=article_topics_table, backref=db.backref("articles"))
    ...
    def before_insert(mapper, connection, target):
        def _format(_html):
            s = do_striptags(_html)
            length=200
            if s > length:
                s = s[0:length] + '...'

            return s
            #return do_truncate(do_striptags(_html), length=200,killwords=True)
